  ...
  add(){
    if( this.edit.first_name == "" || this.edit.first_name == undefined ){
     ...
     if (this.fileListData.length > 0) {
      ...
      formData.append('first_name', this.edit.first_name);
      formData.append('phone_number', this.edit.phone_number); 
      formData.append('image', this.fileListData[0]);    
      this.services.edit(formData).subscribe(
        data => {
          if(data.status == '200'){
